...
- 보라·핑크 그라데이션 “AI 대시보드” 팔레트 유지 — 실제 앱 스크린(Mobbin)으로 토큰을 다시 잡음
...
- **레퍼런스 툴:** [`docs/design-tools.md`](design-tools.md) — **1순위 Mobbin MCP**(실서비스 화면), 웹은 Refero/Land-book, 인터랙션은 uiverse(Vanilla CSS).
